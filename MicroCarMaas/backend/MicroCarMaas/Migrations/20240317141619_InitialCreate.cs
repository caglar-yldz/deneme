        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CarOwnerSurname = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "RentingCarPhotos",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    BeforeRentingImgUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AfterRentingImgUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CarId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RentingCarPhotos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RentingCarPhotos_Cars_CarId",
                        column: x => x.CarId,
                        principalTable: "Cars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DrivingLicenceId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_DrivingLicences_DrivingLicenceId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RentingPrice = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsPaymentDone = table.Column<bool>(type: "bit", nullable: true),
                    RentingLocation = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_DrivingLicenceId",
                table: "AspNetUsers",
                column: "DrivingLicenceId",
                unique: true,
                filter: "[DrivingLicenceId] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RentingCarPhotos_CarId",
                table: "RentingCarPhotos",
                column: "CarId");
